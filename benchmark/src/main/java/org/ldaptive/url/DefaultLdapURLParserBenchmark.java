...
/**
 * Benchmark for {@link DefaultUrlParser}.
 *
...
public class DefaultLdapURLParserBenchmark
{
  ...
  public void setup()
  {
    urlParser = new DefaultUrlParser();
  }


  /**
   * Benchmark {@link DefaultUrlParser#parse(String)}.
   *
