 ...
 */
public class PooledConnectionFactoryBeanDefinitionParser extends AbstractPooledConnectionFactoryBeanDefinitionParser
{
    ...
    final BeanDefinitionBuilder builder)
  {
    ...
    builder.addPropertyValue("connectionPool", parseConnectionPool(name, element, true).getBeanDefinition());
  }
}
