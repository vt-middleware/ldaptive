...
public class LessOrEqualFilter extends AbstractAttributeValueAssertionFilter
{
  ...
  {
    super(Type.LESS_OR_EQUAL, name, value.getBytes(StandardCharsets.UTF_8));
  }
   ...
   */
  public static LessOrEqualFilter parse(final String component)
  {
    ...
    if (m.matches()) {
      ...
      return new LessOrEqualFilter(attr, value);
    }
    return null;
  }
