...
public class EhcacheTest
{
    ...
    throws Exception
  {
    final net.sf.ehcache.Cache ehcache = new net.sf.ehcache.Cache(
      new CacheConfiguration("test", 5).memoryStoreEvictionPolicy(MemoryStoreEvictionPolicy.LRU).eternal(
        false).timeToLiveSeconds(0).timeToIdleSeconds(0).diskExpiryThreadIntervalSeconds(3));
