/*
  $Id: SearchTemplatesTest.java 2885 2014-02-05 21:28:49Z dfisher $
...
public class SearchTemplatesTest
{
  ...
  public Object[][] createTestData()
  {
    ...
    final SearchFilter sf23 = new SearchFilter(
      "(&(givenName={term1}*)(sn={term2}*))");
    ...
    final SearchFilter sf25 = new SearchFilter(
      "(&(givenName=*{term1}*)(sn=*{term2}*))");
    ...
    final SearchFilter sf32 = new SearchFilter(
    ...
    final SearchFilter sf34 = new SearchFilter(
      "(|(cn={term1}* {term2}* {term3}*)(cn={term2}* {term1}* {term3}*))");
    ...
    return
      new Object[][] {
        ...
        },
        {
          ...
          new SearchFilter[] {
            sf21, sf22, sf23, sf24, sf25, sf26, sf27, sf28,
          },
        },
        {
          new SearchTemplates(
